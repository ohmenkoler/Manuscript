\begin{tikzpicture}
    ...
    legend style = {at={(1.01,.05)},anchor = south east},legend columns=3,
		...
		\addplot[ultra thick,MatlabBlue] file {{../fig/fig_ConvNat_Acou/data/DataMatTxtV1V2Mid/data_TC10_0beg_RixMid_PhaseRIXHP-60°_OrientationV1_Qc0W_Serie1.txt}};\addlegendentry{}
    	...
    	\addplot[ultra thick,MatlabOrange] file {{../fig/fig_ConvNat_Acou/data/DataMatTxtV1V2Mid/data_TC11_0beg_RixMid_PhaseRIXHP-60°_OrientationV1_Qc0W_Serie1.txt}};\addlegendentry{}
    	...
    	\addplot[ultra thick,MatlabYellow] file {{../fig/fig_ConvNat_Acou/data/DataMatTxtV1V2Mid/data_TC12_0beg_RixMid_PhaseRIXHP-60°_OrientationV1_Qc0W_Serie1.txt}};\addlegendentry{}
