\begin{tikzpicture}
    ...
    \begin{axis}[name=boundary,width={\width},height={\height},grid=both,minor tick num=5,
    ...
    ytick={-40,-20,...,40},
    domain=0:100,
    legend style = {at={(1.01,.025)},anchor = south east,rounded corners},legend columns=3,fill opacity=.5,text opacity=1
    ]
