...
%	\addlegendimage{only marks, mark=oplus}
	...
	\addplot[only marks, mark=diamond*,color=Plasma1, mark size=5pt] file {../fig/fig_PerfConvNat/data/V1_COP_DR_Qc100.txt};%\addlegendentry{`\texttt{V1}'};
	\addplot[only marks, mark=diamond*,color=Plasma25, mark size=4pt] file {../fig/fig_PerfConvNat/data/V2_COP_DR_Qc100.txt};%\addlegendentry{`\texttt{V2}'};
	\addplot[only marks, mark=diamond*,color=Plasma50, mark size=3pt] file {../fig/fig_PerfConvNat/data/H1_COP_DR_Qc100.txt};%\addlegendentry{`\texttt{H1}'};
	\addplot[only marks, mark=diamond*,color=Plasma75, mark size=2pt] file {../fig/fig_PerfConvNat/data/H2_COP_DR_Qc100.txt};%\addlegendentry{`\texttt{H2}'};
	\end{axis}
\end{tikzpicture}