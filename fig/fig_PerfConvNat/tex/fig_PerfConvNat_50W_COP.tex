...
%		legend entries={`\texttt{V1}', `\texttt{V2}', `\texttt{H1}', `\texttt{H2}', \qty{0}{\watt}, \qty{50}{\watt}, \qty{100}{\watt}, \textsc{DeltaEC}}
	...
	\addplot[only marks, mark=triangle*,color=Plasma25, mark size=4pt] file {../fig/fig_PerfConvNat/data/V2_COP_DR_Qc50.txt};%\addlegendentry{`\texttt{V2}'};
	\addplot[only marks, mark=triangle*,color=Plasma50, mark size=3pt] file {../fig/fig_PerfConvNat/data/H1_COP_DR_Qc50.txt};%\addlegendentry{`\texttt{H1}'};
	\addplot[only marks, mark=triangle*,color=Plasma75, mark size=2pt] file {../fig/fig_PerfConvNat/data/H2_COP_DR_Qc50.txt};%\addlegendentry{`\texttt{H2}'};
