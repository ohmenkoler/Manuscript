\begin{tikzpicture}[scale=.2]
	...
	\draw[MatlabOrange,->] (AHX.north east) to[out=0,in=-90] (\lAHX/2,-\rAHX);
	
	\begin{scope}[xshift=\lAHX] % Reg
		\fill[pattern=crosshatch,pattern color=gray,draw=black] (0,-\rREG) rectangle ++(\lREG,2*\rREG);
		\draw[black] (\lREG/2,.5*\rREG) node[anchor=center, rounded corners, rotate=90, fill=white]{Régén.};		
	...
	\draw[MatlabBlue,->] (CHX.north west) to[out=180,in=-90] (\lCHX/2,-\rCHX);
