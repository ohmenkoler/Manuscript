...
%    	2.5/10000,5/10000,1/1000},
    ...
    legend style = {at={(.98,.98)},anchor = north east,rounded corners}
        ...
        \addplot[solid,ultra thick,draw=Plasma33] file {../fig/fig_dKdV/data/data_dK.txt};
        \addplot[solid,ultra thick,draw=Plasma66] file {../fig/fig_dKdV/data/data_dV.txt};
        \filldraw[Plasma33] (\xcursor,\ycursorK) circle (2pt) node[above right]{$\delta_\kappa=\qty{\ycursorK}{\meter}$};
        \filldraw[Plasma66] (\xcursor,\ycursorV) circle (2pt) node[below left]{$\delta_\nu=\qty{\ycursorV}{\meter}$};
