...
%    	2.5/10000,5/10000,1/1000},
    ...
    legend style = {at={(.98,.98)},anchor = north east,rounded corners}
    ]
        ...
        \filldraw[MatlabBlue] (\xcursor,\ycursorK) circle (2pt) node[above right]{$\delta_\kappa=\qty{\ycursorK}{\meter}$};
        \filldraw[MatlabOrange] (\xcursor,\ycursorV) circle (2pt) node[below left]{$\delta_\nu=\qty{\ycursorV}{\meter}$};
