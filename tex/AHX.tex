...
\section{Détermination de la quantité de chaleur pompée}
...
L'écart de température d'eau diminue quand le débit augmente, et les incertitudes de mesures sont donc plus importantes à haut débit. En revanche, la mesure du débit d'eau est meilleure à haut débit (voir la figure~\ref{fig:IncertitudeDebitEau}. Le flux de chaleur calculé ne semble pas dépendre du débit, et une valeur intermédiaire, à \qty{7}{\litre\per\minute}, est choisie pour la circulation dans l'échangeur ambiant.
