...
L'objectif principal de cette thèse expérimentale est d'analyser et de quantifier l'effet de la convection naturelle sur cette distribution de température. Une approche combinant expérimentations réalisées en suivant un protocole minutieux, et simulations numériques est adoptée pour étudier les mécanismes sous-jacents régissant les transferts thermiques dans le noyau, en pivotant la pompe à chaleur et son noyau dans diverses orientations d'intérêt. Un modèle théorique temporel du régime transitoire est également développé pour prédire le comportement du système et ainsi améliorer la compréhension de la machine. Il est montré que la distribution de température est grandement impactée par la circulation de gaz dans la cavité s'ouvrant sur le noyau.
...
The main goal of this experimental PhD work is to analyse and quantify the effect of natural convection on that temperature distribution. Experimental studies performed by following a thorough protocol, and numerical simulations are combined to study the heat transfer mecanisms at play in the core, by rotating the heat pump and its core in all sorts of interesting orientations. A time domain, analytical simulation of the transient regime is also developed in order to predict the behaviour of the system and thus, enhance the understanding of the machine. It is proven that the temperature distribution is greatly impacted by the gaz flow in the cavity facing the core.
