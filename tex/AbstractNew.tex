...
%		\input{pgfplotsset_colormap_plasma}
...
%{\normalsize
	...
	\begin{tabular}{llr}
	\textbf{D. \textsc{Baltéan-Carlès}} & Maîtresse de conférence, LISN, Sorbonne Université & \textit{Rapporteure} \\
	\textbf{F. \textsc{Lanzetta}} & Professeur, FEMTO-ST, Université Bourgogne Franche-Comté & \textit{Rapporteur} \\
	\textbf{R. \textsc{Keolian}} & Professeur \'Emérite, College of Engineering, University of Pennsylvania & \textit{Examinateur} \\
	\textbf{G. \textsc{Penelet}} & Professeur, LAUM, Le Mans Université & \textit{Examinateur} \\
	\textbf{I. \textsc{Ramadan}} & Maître de conférence, Institut PPRIME, Université de Poitiers & \textit{Examinateur} \\
	\textbf{H. \textsc{Bailliet}} & Maîtresse de conférence, Institut PPRIME, Université de Poitiers & \textit{Directrice} \\
	\textbf{G. \textsc{Poignand}} & Ingénieure d'étude, LAUM, Le Mans Université & \textit{Codirectrice} \\
	\textbf{J.-C. \textsc{Valière}} & Professeur, Institut PPRIME, Université de Poitiers & \textit{Codirecteur} 
	\end{tabular}
...
En particulier, l'effet de la convection naturelle sur cette distribution de température est étudié. Un protocole expérimental est développé pour assurer la fiabilité des mesures, et la comparaison des résultats expérimentaux avec ceux calculés par simulations numériques permet d'étudier les mécanismes sous-jacents régissant les transferts thermiques dans le noyau, en pivotant la machine dans diverses orientations d'intérêt. Un modèle théorique temporel du régime transitoire est également adapté pour prédire le comportement du système et ainsi améliorer sa compréhension. Il apparaît que la distribution de température est grandement impactée par la circulation de fluide dans la cavité jouxtant le noyau.
...
\begin{multicols}{2}
Thermoacoustics is an interdisciplinary domain, at the interface between heat transfers, fluid mechanics and acoustics, and constists in the interaction between acoustic waves and heat exchanges. This work is focused on a thermoacoustic refrigerator, and especially on the measurement and the analysis of the complex temperature distribution in its core.
...
In particular, the effect of natural convection on that temperature distribution is studied. An experimental protocol is developed to ensure the reliability of the measurements, and the comparison of the experimental results with those obtained through numerical simulations allows to study the heat transfer mecanisms at play in the core, by rotating the machine in all sorts of interesting orientations. A time domain, analytical simulation of the transient regime is also adapted in order to predict the behaviour of the system and thus, enhance its understanding. It appears that the temperature distribution is greatly impacted by the fluid flow in the cavity facing the core.

This study allows to progress in the caractrisation of the impact of natural convection on the temperature distribution in thermoacoustic machines.
\end{multicols}
\bigskip
