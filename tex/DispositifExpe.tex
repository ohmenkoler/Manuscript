...
%		\externalremake
	...
	\end{subfigure}  
    \caption{Valeurs \ref{fig:DeltaEC_u_opt_Qth} du flux de chaleur $\dot Q_f$ extrait par l'échangeur froid, et \ref{fig:DeltaEC_u_opt_COP} du coefficient de performance $\COP=\nicefrac{Q_f}{p_1 u_1}$, en fonction de l'amplitude et la phase du débit acoustique $u_1$.}
