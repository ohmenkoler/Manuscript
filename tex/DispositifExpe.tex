...
%		\externalremake
	...
	\end{subfigure}  
    \caption{Valeurs \ref{fig:DeltaEC_u_opt_Qth} du flux de chaleur thermoacoustique et \ref{fig:DeltaEC_u_opt_COP} du coefficient de performance, en fonction de l'amplitude et la phase du débit acoustique $u$. \echaf{ces data sont nimp}}
