...
%		\externalremake
		\input{../fig/fig_DeltaEC_u_opt/tex/fig_DeltaEC_u_opt_DeltaT}
		\caption{}
...
%		\externalremake
	...
	\end{subfigure}  
    \caption{Valeurs \ref{fig:DeltaEC_u_opt_Qth} du flux de chaleur thermoacoustique, \ref{fig:DeltaEC_u_opt_DeltaT} de l'écart de température de part et d'autre du régénérateur, et \ref{fig:DeltaEC_u_opt_COP} du coefficient de performance, en fonction de l'amplitude et la phase du débit acoustique $u$. \echaf{ces data sont nimp}}
