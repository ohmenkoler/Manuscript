...
\end{equation}
avec $d_w$ le diamètre du fil \cite{swift_thermoacoustics_2017}. Dans la théorie linéaire de Rott, la porosité et le rayon hydraulique sont les deux paramètres nécessaires à la caractérisation acoustique du noyau. Le régénérateur peut également être modélisé comme un matériau poreux homogène équivalent possédant des propriétés effectives équivalentes d'un point de vue macroscopique, adopté notamment dans certaines études numériques pour réduire le temps de calcul. Cette approche sert aussi dans l'étude de l'influence de la convection naturelle dans un matériau poreux \cite{di_meglio_novel_2022, di_meglio_cfd_2022}. Les paramètres mis en avant par cette approche sont la perméabilité équivalente, c'est-à-dire la capacité du milieu à laisser passer un écoulement, et la conductivité thermique équivalente. La perméabilité tensorielle notée $\mathbf K_p$, qui intervient dans la loi de Darcy en trois dimensions, se définit par
...
Ce cycle où les transformations sont isothermes est celui de Stirling, pour lequel les oscillations de pression et de vitesse sont en phase. Cependant, ce cycle représente un comportement asymptotique, et il a été montré dans la littérature portant sur les machines à plusieurs sources qu'il existe une vitesse acoustique optimal pour une pression acoustique donnée, et en particulier un déphasage proche mais différent de \ang{0}~\cite{poignand_analysis_2013, poignand_etude_2006, poignand_optimal_2007, poignand_thermoacoustic_2011}, et ce, suivant la quantité à maximiser ($Q_f,\ \COP$...). La connaissance de ces valeurs optimales des amplitude et phase du débit acoustique permet ensuite, lors de la conception sous \textsc{DeltaEC}, de dimensionner chaque élément du circuit acoustique sans s'écarter de ce déphasage optimal.\medskip
...
L'instrumentation utilisée est celle conçue au début du projet \cite{ramadan_design_2021}, tout en modifiant quelques éléments nécessaires à l'observation des phénomènes recherchées. Tous les capteurs installés dans le réfrigérateur sont montrés sur la figure~\ref{fig:Capteurs}.
...
Quelques questions sont alors formulées, auxquelles il faut répondre en choisissant judicieusement des configurations expérimentales adaptées. Tout d'abord, . La deuxième question porte ensuite sur l'allure de l'éventuelle cellule de convection, suivant la zone de la machine concernée. Enfin, la troisième question concerne les performances et leur potentielle perturbation par un flux de chaleur qui s'accompagne de l'écoulement de fluide, s'il existe une configuration plus favorable à sa mise en mouvement.
...
Pour se rendre compte de l'impact de la baisse de pression sur les performances, une série d'expériences réalisées à haute amplitude acoustique dans l'orientation `\texttt{H1}' avec l'échangeur froid alimenté pour maintenir une température de consigne de \qty{15}{\degreeCelsius} au thermocouple~\num{5} a été réalisée en début de thèse, en laissant délibérément le réfrigérateur se vider de son fluide. En observant, sur la figure~\ref{fig:PressStatique}, le flux de chaleur nécessaire pour assurer l'équilibre de température, ainsi que le coefficient de performances obtenu en rapportant ce flux de chaleur à la puissance consommée par les sources acoustiques. Si la figure~\ref{fig:Qc_PressStatique} montre que la puissance pompée par effet thermoacoustique est relativement constant, la figure~\ref{fig:COP_PressStatique} montre quant à elle une augmentation de la puissance consommée par les sources acoustiques lorsque la pression statique diminue.\medskip
...
%	\externalremake
	...
	\caption{Example de mesure de température de gaz après mise en marche du réfrigérateur à haute amplitude acoustique.}
	\label{fig:AcouExample}
\end{figure}

Cependant, si dans le cas de l'expérience tracée sur la figure~\ref{fig:AcouExample} la distribution de température se stabilise très vite, ce n'est pas toujours le cas. En l'occurrence, lors de deux autres expériences réalisées l'une à la suite de l'autre et dont les évolutions de températures des thermocouples 7 et 8 sont tracées sur la figure~\ref{fig:Repetabilite_V1}, le comportement est complètement différent. Sur le même intervalle de temps de \qty{600}{\second}, au lieu de se stabiliser à une température située entre celles du côté ambiant et du côté froid comme sur la figure~\ref{fig:AcouExample}, les thermocouples 7 et 8 dont les températures sont tracées sur la figure~\ref{fig:Repetabilite_V1} enregistrent une augmentation suivie d'une diminution de la température de \qty{10}{\degreeCelsius} pour le 1\ier{} jour, et une augmentation par palier de l'ordre de \qty{15}{\degreeCelsius} pour le 2\ieme{} jour.\smallskip
...
Le but ici n'est cependant pas de tenter d'expliquer la cause de ces comportements, mais plutôt de montrer le besoin d'acquisitions suffisamment longues pour atteindre un régime stationnaire.

Pour prévenir une acquisition trop courte et un risque de manquer l'apparitions d'éventuels phénomènes durant le régime transitoire, les durées d'acquisitions sont supérieures à \qty{1}{\hour} dans chacun des types d'expérience, c'est-à-dire `\texttt{water}', `\texttt{acou}' ou `\texttt{Qc*W}'.
...
\section{Conclusion}
Ce chapitre présente le réfrigérateur existant déjà au début de ce travail de thèse. L'utilisation d'une géométrie coaxiale et de deux sources est d'abord rappelée, justifiée par la nécessité de compacité de la machine et de ciblage du déphasage optimal entre pression et vitesse acoustiques dans le régénérateur.\smallskip

Après la présentation de quelques résultats obtenus dans la littérature et montrant des écarts avec le modèle \textsc{DeltaEC}, l'hypothèse de présence d'écoulements de fluides causés par la convection naturelle est formulée. Pour la valider ou non, le système est orienté dans quatre orientations choisies pour leur caractère académique.
