...
\end{equation}
avec $d_w$ le diamètre du fil \cite{swift_thermoacoustics_2017}. Ce milieu poreux dispose d'une certaine capacité à laisser passer un écoulement. C'est la perméabilité \echaf{tensorielle} notée $\mathbf K_p$, qui intervient dans la loi de Darcy \echaf{en trois dimensions}
...
\subparagraph{\'Echangeur ambiant} \label{chap:DispExpe_AHX}
...
\subparagraph{\'Echangeur froid} \label{chap:DispExpe_CHX}
...
\echaf{reprendre relecture de là}
