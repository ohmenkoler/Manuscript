...
%    \externalremake
    ...
    \caption{Schéma général du réfrigérateur \textsc{Tacot} extrait de \cite{ramadan_design_2021}. \textbf{(a)} agrandissement sur la boucle de rétroaction entre le noyau et le bâti de la machine, et \textbf{(b)} ensemble de la machine. Le noyau thermoacoustique et le cône d'adaptation d'impédance sont mis en évidence.\echaf{surligner la rétroaction}}
...
%	\externalremake
	...
	\caption{Schéma de la machine avec tous les emplacements des capteurs}
	\label{fig:Capteurs}
\end{figure}
