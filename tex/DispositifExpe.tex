...
\end{equation}
où $\Delta T^{(w)}$ représente la différence de température d'eau entre la sortie et l'entrée de la conduite dans l'échangeur ambiant.
...
Cependant, si dans le cas de l'expérience tracée sur la figure~\ref{fig:AcouExample} la distribution de température se stabilise très vite, ce n'est pas toujours le cas. En l'occurrence, lors de deux autres expériences réalisées l'une à la suite de l'autre et dont les évolutions de températures des thermocouples 7 et 8 sont tracées sur la figure~\ref{fig:Repetabilite_V1}, le comportement est complètement différent.\echaf{ici}\smallskip

Pour prévenir une acquisition trop courte et un risque de manquer l'apparitions d'éventuels phénomènes durant le régime transitoire, les durées d'acquisitions sont supérieures à \qty{1}{\hour} dans chacun des types d'expérience (`\texttt{water}', `\texttt{acou}' ou `\texttt{Qc*W}').
