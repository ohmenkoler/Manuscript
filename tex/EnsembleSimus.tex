...
Ainsi, la géométrie considérée est toujours en trois dimensions pour les orientations horizontales, mais réduite à un quart du total. L'usage de conditions aux frontières symétriques sur les parois \echaf{correspondantes/appropriées} permettent cette simplification. Dans le cas des orientations verticales, la géométrie conservée est une version en deux dimensions, en utilisant une condition d'axisymétrie sur les frontières au centre du noyau.

\bigskip \echaf{ajouter 2 figures pour les géométries}
