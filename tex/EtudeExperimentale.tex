...
\paragraph{Sans acoustique}
Avant de s'intéresser aux expériences dans lesquelles tous les effets sont combinés, un essai est exécuté en l'absence de sources acoustique pour étudier l'effet de la convection naturelle pour une fréquence nulle. La figure \ref{fig:HeatOnly_CHXout_V1V2} montre l'évolution de la température dans la cavité d'adaptation d'impédance, après allumage d'une charge thermique fournie par les résistances chauffantes placées dans l'échangeur froid. À \qty{50}{\second}, les charges thermiques sont alimentées, et les températures à proximité immédiate de l'échangeur --- les thermocouples \numlist{1;2;3} --- augmentent. La charge thermique est la même dans les deux orientations, mais les températures atteintes diffèrent : le thermocouple au centre relève \textcolor{red}{blabla}. L'explication vient en observant également le comportement de la température de l'autre côté de la cavité, devant la source acoustique principale. En effet, l'allure des courbes noires est complètement différente d'une orientation à l'autre. Dans le cas où la source acoustique est en dessous du noyau, l'évolution de la température est nulle, tandis que lorsqu'elle est au-dessus, sa température est égale à celle relevée autour de la charge thermique, quand bien même avec un retard dû à la vitesse.
...
En revanche, la figure~\ref{fig:Acou_CHXout_V1V2_High} qui présente les résultats obtenus à haute amplitude, c'est-à-dire pour un \textit{drive ratio} de $DR=\qty{3.6}{\percent}$, les effets liés à la convection naturelle sont visibles. En effet, les tendances sont les mêmes qu'à faible amplitude acoustique, à d'autres échelles en termes d'amplitude ce température ou de temps, et une différence de résultats de l'ordre de \qty{6}{\degreeCelsius} est manifeste en fonction de l'orientation du réfrigérateur. Notamment, les courbes en trait tiretés qui représentent l'orientation `\texttt{V2}' montrent à nouveau un refroidissement de la zone avant une stabilisation des températures, tandis que les courbes en trait plein affichent un réchauffement à $t=\qty{400}{\second}$ entre le refroidissement initial et la stabilisation des températures dans la cavité conique dans l'orientation `\texttt{V1}'.
