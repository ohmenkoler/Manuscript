...
%   	\externalremake
	...
	\end{subfigure}
	\caption{Valeurs du coefficients de performances en fonction de la charge thermique appliquée à l'échangeur froid, à différents \textit{drive ratios}. \subref{fig:PerfConvNat_COP_DR2} $DR=\qty{2}{\percent}$, et \subref{fig:PerfConvNat_COP_DR35} $DR=\qty{3.5}{\percent}$.}
