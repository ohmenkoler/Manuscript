...
%    	\hline
        ...
        \textbf{Symbole} & \textbf{Définition} \\\hline\hline
        $\theta_v$ & Rotation de l'axe de symétrie du réfrigérateur par rapport à l'axe horizontal\\
        $\theta_h$ & Rotation autour de l'axe de symétrie du réfrigérateur \\
        ...
        $\tau$ & Différence entre les températures locale dans le réfrigérateur et initiale, $\tau=T_0-T_\infty$\\
