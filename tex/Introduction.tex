...
\subsection{Fonction visco-thermiques}
\cite{swift_thermoacoustics_2017, di_giulio_wire_2023}

Pour des pores de géométrie cylindrique : 
...
\begin{multicols}{2}
	...
	\begin{subequations}
		\begin{align}
			h_\kappa(r) &= \echaf{\dfrac{J_0\left[(1-i)\dfrac{r}{\delta_\kappa}\right]}{J_0\left[(1-i)\dfrac{r_h}{\delta_\kappa}\right]}}
			\label{eq:FonctionThermique_k} \\
			f_\kappa &= \echaf{\dfrac{2J_1\left[(1-i)\dfrac{r_h}{\delta_\kappa}\right]}{(1-i)\dfrac{r_h}{\delta_\kappa}J_0\left[(1-i)\dfrac{r_h}{\delta_\kappa}\right]}}
...
\end{multicols}
où $J_0$ et $J_1$ sont les fonctions de Bessel de première espèce, respectivement d'ordres \num{0} et \num{1}.

\subsubsection{Milieu tortueux}

\cite{allard_propagation_2009}
