...
\begin{equation}
	\deriv p_1 = -\frac{i\omega \rho_0 \deriv x}{S(1-f_\nu)}u_1,
\end{equation}
...
\begin{equation}
	\rho_0 c_p (i\omega_1 T_1 + v_1\deriv_x T_0) - i\omega_1 p_1 = k[\partial^2_{yy} T_1 + \partial^2_{zz}T_1],\echaf{continuer}
\end{equation}
...
La théorie linéaire montre que le champ de pression acoustique au sein d'un matériau poreux est solution de l'équation de Helmholtz qui s'écrit~\cite{rott_damped_1969, swift_thermoacoustic_1988, swift_thermoacoustics_2017}
