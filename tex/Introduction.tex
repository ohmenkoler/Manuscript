...
\begin{multicols}{2}
	...
	\begin{subequations}
		\begin{align}
			h_\nu(r) &= \frac{J_0[(1-i)\frac{r}{\delta_\nu}]}{J_0[(1-i)\frac{r_h}{\delta_\nu}]}
			\label{eq:FonctionViqueuse_r} \\
			f_\nu &= \frac{2J_1[(1-i)\frac{r_h}{\delta_\nu}]}{(1-i)\frac{r_h}{\delta_\nu}J_0[(1-i)\frac{r_h}{\delta_\nu}]}
	...
	\begin{subequations}
		\begin{align}
			h_\kappa(r) &= \echaf{\frac{J_0[(1-i)\frac{r}{\delta_\kappa}]}{J_0[(1-i)\frac{r_h}{\delta_\kappa}]}}
			\label{eq:FonctionThermique_k} \\
			f_\kappa &= \echaf{\frac{2J_1[(1-i)\frac{r_h}{\delta_\kappa}]}{(1-i)\frac{r_h}{\delta_\kappa}J_0[(1-i)\frac{r_h}{\delta_\kappa}]}}
