...
Ici, les indices indiquent l'ordre de grandeur, avec en particulier l'indice \num{0} qui dénote une valeur constante à l'ordre \num{0}, et l'indice \num{1} qui signifie l'oscillation à l'ordre \num{1} de la quantité. Pour respecter l'hypothèse de linéarité du système, il est nécessaire que pour chaque quantité la condition des petites variations soit respectée, soit 
