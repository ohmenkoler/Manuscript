...
%{\normalsize
	...
	Soutenue le \echaf{16 juin 2025}
	\vfill
	...
	\begin{tabular}{llr}
	\textbf{Prénom \textsc{Nom}} & Grade, Université & \textit{Rôle} \\
	\textbf{Prénom \textsc{Nom}} & Grade, Université & \textit{Rôle} \\
	\textbf{Prénom \textsc{Nom}} & Grade, Université & \textit{Rôle} \\
	\textbf{Prénom \textsc{Nom}} & Grade, Université & \textit{Rôle} \\
	\textbf{Prénom \textsc{Nom}} & Grade, Université & \textit{Rôle} \\
	\textbf{H. \textsc{Bailliet}} & Maîtresse de conférence, Institut PPRIME, Université de Poitiers & \textit{Directrice} \\
	\textbf{G. \textsc{Poignand}} & Ingénieure d'étude, LAUM, Le Mans Université & \textit{Co. dir.} \\
	\textbf{J.-C. \textsc{Valière}} & Professeur, Institut PPRIME, Université de Poitiers & \textit{Co. dir.} 
	\end{tabular}
