...
\usepackage{subcaption}
	...
	\captionsetup{labelfont=bf,font=small,width=.95\textwidth}
...
%        \hrule\leavevmode\\[0.3cm]
        \textbf{\Large \'Etude expérimentale d'un réfrigérateur thermoacoustique compact : \\ effets de la convection naturelle} %\\[0.65cm]
%        \hrule
    \vfill
%{\normalsize
	Direction de thèse :\smallskip 
	
	\begin{tblr}{rows = {12pt}, columns = {l}, column{1} = {font=\bf}}
...
%	\vfill
	...
	{\scriptsize
	\begin{tabular}{llr}
	\textbf{D. \textsc{Baltéan-Carlès}} & Maîtresse de conférences HDR, LISN, Sorbonne Université & \textit{Rapporteure} \\
	\textbf{F. \textsc{Lanzetta}} & Professeur des Universités, FEMTO-ST, Université Marie et Louis Pasteur & \textit{Rapporteur} \\
...
%	\textbf{I. \textsc{Ramadan}} & Maître de conférences, Institut PPRIME, Université de Poitiers & \textit{Examinateur} \\
	\textbf{H. \textsc{Bailliet}} & Maîtresse de conférences HDR, Institut PPRIME, Université de Poitiers & \textit{Directrice} \\
	\textbf{G. \textsc{Poignand}} & Ingénieure d'étude, LAUM, Le Mans Université & \textit{Codirectrice} \\
	\textbf{J.-C. \textsc{Valière}} & Professeur des Universités, Institut PPRIME, Université de Poitiers & \textit{Codirecteur} 
	\end{tabular}
	}
...
\begin{figure}[p]
\centering
	\includegraphics[width=\textwidth]{../fig/fig_PhotosDuTacot/TacotH1.jpg}
\end{figure}
\cleardoublepage
...
\input{DispositifExpe}

\input{EnsembleSimus}

\input{EtudeExperimentale}
...
%\input{CircuFluideOrientV2}

%\input{AHX}

\input{CoeffH_Transitoire}
...
%\input{ChangeTraversees

\input{DeltaECProgrammeComplet}
