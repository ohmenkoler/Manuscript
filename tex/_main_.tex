...
\usepackage{subcaption}
	...
	\captionsetup{labelfont=bf,font=footnotesize,width=.95\textwidth}
...
%    \includegraphics[height=4cm]{{/run/media/ohmenkoler/Samsung_T5/Docs/Université/Templates_LaTex/Logos/imdea.JPG}}
    \vfill
   	\textsc{Université de Poitiers \\ Institut Pprime}
    \vfill
        \hrule\leavevmode\\[0.3cm]
        \huge\textbf{Optimisation d'un réfrigérateur thermoacoustique compact} \\[0.65cm]
        \hrule
    \vfill
